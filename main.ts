...
function cutsean_1 () {
    ...
    story.queueStoryPart(function () {
        ...
        bullseye.setPosition(208, 208)
        story.printText("my weak spot is sooo hard to see (im such a liar)", 1296, 988, 2, 15, story.TextSpeed.Normal)
    })
}
